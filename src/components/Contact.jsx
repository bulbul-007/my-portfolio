...
const Contact = () => {
  // Using native HTML form submission to FormSubmit.co for maximum reliability
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="mt-10">
              <h4 className="text-slate-400 text-sm font-medium mb-6 uppercase tracking-wider flex items-center gap-4">
              ...
              <div className="flex flex-col gap-4">
                <a href="https://github.com/bulbul-007" target="_blank" rel="noreferrer" className="group flex items-center justify-between p-4 glass-card rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-500 overflow-hidden relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-slate-800/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0"></div>
                  <div className="flex items-center gap-5 relative z-10">
                    <div className="w-12 h-12 rounded-full bg-slate-800/80 border border-white/10 flex items-center justify-center text-slate-300 group-hover:text-white group-hover:bg-slate-700 transition-all duration-300 shadow-inner group-hover:scale-110">
                      <GithubIcon size={22} />
                    </div>
                    <div>
                      <h5 className="text-white font-semibold text-base group-hover:text-primary-400 transition-colors">GitHub</h5>
                      <p className="text-slate-400 text-xs mt-0.5">Explore my source code & projects</p>
                    </div>
                  </div>
                  <div className="relative z-10 text-slate-500 group-hover:text-primary-400 group-hover:translate-x-1 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                  </div>
                </a>

                <a href="https://linkedin.com/in/bulbul-ahmed4500b0389" target="_blank" rel="noreferrer" className="group flex items-center justify-between p-4 glass-card rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-500 overflow-hidden relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-900/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0"></div>
                  <div className="flex items-center gap-5 relative z-10">
                    <div className="w-12 h-12 rounded-full bg-slate-800/80 border border-white/10 flex items-center justify-center text-slate-300 group-hover:text-white group-hover:bg-blue-600 transition-all duration-300 shadow-inner group-hover:scale-110">
                      <LinkedinIcon size={22} />
                    </div>
                    <div>
                      <h5 className="text-white font-semibold text-base group-hover:text-blue-400 transition-colors">LinkedIn</h5>
                      <p className="text-slate-400 text-xs mt-0.5">Let's connect & talk professionally</p>
                    </div>
                  </div>
                  <div className="relative z-10 text-slate-500 group-hover:text-blue-400 group-hover:translate-x-1 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                  </div>
                </a>

                <a href="https://bulbulahamedportfolio.netlify.app" target="_blank" rel="noreferrer" className="group flex items-center justify-between p-4 glass-card rounded-2xl border border-white/5 hover:border-white/20 transition-all duration-500 overflow-hidden relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-0"></div>
                  <div className="flex items-center gap-5 relative z-10">
                    <div className="w-12 h-12 rounded-full bg-slate-800/80 border border-white/10 flex items-center justify-center text-slate-300 group-hover:text-white group-hover:bg-emerald-500 transition-all duration-300 shadow-inner group-hover:scale-110">
                      <PortfolioIcon size={22} />
                    </div>
                    <div>
                      <h5 className="text-white font-semibold text-base group-hover:text-emerald-400 transition-colors">Live Portfolio</h5>
                      <p className="text-slate-400 text-xs mt-0.5">View my previous portfolio site</p>
                    </div>
                  </div>
                  <div className="relative z-10 text-slate-500 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
                  </div>
                </a>
              </div>
          ...
          >
            <div className="relative glass-card p-1 rounded-2xl overflow-hidden group">
              ...
              <form
                ...
                action="https://formsubmit.co/mbbulbuli2@gmail.com"
                method="POST"
                target="_blank"
              >
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-slate-800/80 border border-white/10 rounded-xl pl-11 pr-4 py-3.5 text-white focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all placeholder:text-slate-600"
                        placeholder="mbbulbuli2@gmail.com"
                      />
                    </div>
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full relative overflow-hidden px-8 py-4 bg-gradient-to-r from-primary-600 to-secondary-500 rounded-xl text-white font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-3 hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] group/btn"
                >
                  <span className="relative z-10">Send a mail</span>
